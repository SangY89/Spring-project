...
<body>
	<div class="container">
		...
		<aside class="sidebar">
			...
			<ul>
				<li class="mb-2"><a
					...
					class="text-blue-500">메인화면</a></li>
				<li class="mb-2"><a
					href="${pageContext.request.contextPath}/member/member-main"
					class="text-blue-500">채용관리</a></li>
			</ul>
			 <c:if
               ...
               <div class="login-inquiry mt-auto">
                  <a href="${pageContext.request.contextPath}/member/member-logout"
                     method="post">
                     <button type="submit" class="inquiry-button">로그아웃</button></a>
		...
		<div class="main-content">
			...
			<!-- Filters -->
			<div class="filters">
				<a href="${pageContext.request.contextPath}/anno/user-my-anno-list"><button
						class="active">내 공고</button></a>
				<button>모든 공고</button>
