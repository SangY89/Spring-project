	...
	<div
		...
		<form method="post" name="resumeForm"
			...
			<header class="text-center mb-6">
				<input value="${resume.resumeTitle }" name="resumeTitle"
				...
				<div class="w-full md:w-1/3 px-2">
					...
					<div class="image-upload-wrapper">
						<img id="profileImage"
							...
							alt="Profile Image"> <input value="${resume.profileImage}"
							name="profileImageFile" type="file" id="imageUpload" accept="image/*"
				...
				<div class="w-full md:w-2/3 px-2">
					...
					<div class="mb-4">
						...
						<textarea name="selfInfo"
							...
							rows="4"
							placeholder="채용담당자에게 특별한 인상을 줄 수 있는 지원자님만의 소개 글을 작성해 보세요!">${resume.selfInfo}</textarea>
							...
							<div class="w-full md:w-1/2 px-2">
								...
								<div class="relative">
									<input name="schoolName" value="${resume.edu.schoolName}"
										class="appearance-none border rounded-lg w-full px-3 py-2"
										type="text" id="school-name" placeholder="">
								</div>
							</div>
						</div>
						<div class="flex flex-wrap -mx-2 mb-2">
							<div class="w-full md:w-1/2 px-2">
								...
								<div class="relative">
									<input name="major" value="${resume.edu.major }"
										class="appearance-none border rounded-lg w-full px-3 py-2"
										type="text" id="major" placeholder="">
								</div>
							</div>
						</div>
						...
						<div class="flex flex-wrap -mx-2 mb-2">
							<div class="w-full md:w-1/3 px-2">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="entry-date" placeholder="2022.01">
							</div>
							<div class="w-full md:w-1/3 px-2">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="graduation-date" placeholder="2024.02">
							</div>
							<div class="w-full md:w-1/3 px-2">
								<label class="block text-gray-700 text-sm font-bold mb-2"
						...
						<div class="flex flex-wrap -mx-2">
							<div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="credits" placeholder="4.3">
							</div>
							<div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="total-credits" placeholder="4.5">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="border rounded-lg p-4 bg-gray-50 relative">
						...
						<div class="flex flex-wrap -mx-2 mb-4">
							<div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="company-name" placeholder="회사명을 입력하세요">
							</div>
							<div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="position" placeholder="팀장">
							</div>
							<div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
								<label class="block text-gray-700 text-sm font-bold mb-2"
									...
									class="appearance-none border rounded-lg w-full px-3 py-2"
									type="text" id="department" placeholder="인사팀">
							</div>
						</div>
						<div class="flex flex-wrap -mx-2 mb-4">
							<div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
						...
						<div class="mb-4">
							...
							<textarea name="workPart"
								...
								placeholder="구체적인 역할과 성과 위주의 업무 내용을 작성해보세요. 수치와 함께 표현되면 경험이 잘 전달될 수 있습니다.">${resume.career.workPart}</textarea>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="border rounded-lg p-4 bg-gray-50 relative">
						...
						<div class="mb-4">
							...
							<textarea name="projectInfo"
								...
								placeholder="프로젝트 내용과 본인의 역할, 기여도를 작성해보세요.">${resume.project.projectInfo }</textarea>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="space-y-4">
					...
					<div class="border rounded-lg p-4 bg-gray-50 relative"
						...
						<button type="button"
							...
							onclick="addLinkField()">+ 링크 추가</button>
					</div>
					...
					<div class="border rounded-lg p-4 bg-gray-50 relative"
						...
						<div class="flex items-center mb-4">
							<input name="portfolioFiles"
								value="${resume.portfolio.portfolioFile} class=" appearance-none
								border rounded-l-lg w-full px-3 py-2" type="file"
								onchange="this.nextElementSibling.value = this.value">
							${resume.portfolio.portfolioFile}
						</div>

						<div class="mb-4">
							<label class="block text-gray-700 text-sm font-bold mb-2">첨부
			...
			<input type="hidden" name="careerId"
				value="${resume.career.careerId}"> <input type="hidden"
				name="projectId" value="${resume.project.projectId}"> <input
				type="hidden" name="portfolioId"
				value="${resume.portfolio.portfolioId}">

			<div class="login-inquiry">
				<button type="submit" class="inquiry-button">수정하기</button>
				<a class="inquiry-button"
					href="${pageContext.request.contextPath}/member/member-main">
					홈으로 </a>
			</div>
		</form>
		<div class="login-inquiry"></div>
	</div>
