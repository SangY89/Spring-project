	...
	<div
		...
		<form method="post" name="resumeForm"
			...
			<header class="text-center mb-6">
				<input name="resumeTitle" class="text-2xl font-bold"
			...
			<div class="flex flex-wrap mb-4">
				...
				<div class="w-full md:w-2/3 px-2">
					<div class="mb-4">
						<label class="block text-gray-700 text-sm font-bold mb-2"
							for="name">이름 *</label> <input name="name" value="${member.name}"
					...
					<div class="mb-4">
						...
						<textarea name="selfInfo"
							...
							rows="4"
							placeholder="채용담당자에게 특별한 인상을 줄 수 있는 지원자님만의 소개 글을 작성해 보세요!"></textarea>
					...
					<div class="border rounded-lg p-4 bg-gray-50 relative">
						...
						<div class="mb-4">
							...
							<textarea name="workPart"
								...
								placeholder="구체적인 역할과 성과 위주의 업무 내용을 작성해보세요. 수치와 함께 표현되면 경험이 잘 전달될 수 있습니다."></textarea>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="border rounded-lg p-4 bg-gray-50 relative">
						...
						<div class="mb-4">
							...
							<textarea name="projectInfo"
								...
								placeholder="프로젝트 내용과 본인의 역할, 기여도를 작성해보세요."></textarea>
						</div>
					</div>
				</div>
			</div>
