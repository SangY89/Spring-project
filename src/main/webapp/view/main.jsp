		...
		<div class="container">
			<div class="logo">
				<a href="${pageContext.request.contextPath}/member/main"><img
					src="https://ifh.cc/g/HL86Yz.png" alt="Greeting Logo"
					class="logosize">Greeting</a>
			</div>
			<nav>
				<ul>
					<li><a href="#">제품</a>
			...
			<c:if
				...
				<div class="login-inquiry">
					<a href="${pageContext.request.contextPath}/member/member-login"
						class="inquiry-button" style="color: white;">개인 로그인</a> <a
						href="${pageContext.request.contextPath}/business/business-login"
						class="inquiry-button" style="color: white;">기업 로그인</a>
				</div>
			</c:if>
